...
/**
 * @brief LCD dispaly test function
 * 
 * @param[in]  count
 */
void LCD_Test(uint8_t *count)
{
    ...
    POINT_COLOR = RED;
    LCD_ShowString(0, 0, 200, 24, 24, "Hello, world.");
    LCD_ShowString(0, 40, 200, 16, 16, "City:YinChuan");
    LCD_ShowString(0, 80, 200, 16, 16, "weather:Sunny");
    LCD_ShowString(0, 120, 200, 16, 16, "Date:2022-03-13");
