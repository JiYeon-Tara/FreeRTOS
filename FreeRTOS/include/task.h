 ...
 */
//task.h �ж����˽������ٽ�� �� �˳��ٽ�εĴ���
//������Ҫ�ϸ���ʱ��ִ�У������Ա���ϵĴ���ʱ������ʹ���ٽ��
//FreeRTOS ����Ҳ�㷺ʹ���ٽ�δ��뱣���Ĺ���
//eg: �Լ�ʹ��: ĳЩ������������豸�ĳ�ʼ��....
#define taskENTER_CRITICAL()		portENTER_CRITICAL()
#define taskENTER_CRITICAL_FROM_ISR() portSET_INTERRUPT_MASK_FROM_ISR()//�жϼ���
...
#define taskEXIT_CRITICAL_FROM_ISR( x ) portCLEAR_INTERRUPT_MASK_FROM_ISR( x )//�жϼ���
