...
//进入临界段
//首先关闭所有中断
//然后对记录中断嵌套层次的 全局变量uxCriticalNesting +1
void vPortEnterCritical( void )
{
	...
	Only assert if the critical nesting count is 1 to protect against recursive calls if the
